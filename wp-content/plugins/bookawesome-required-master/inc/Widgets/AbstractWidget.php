...
abstract class AbstractWidget extends \WP_Widget {
	...
	public function locateTemplate( $filename ) {
		...
		$theme_dir = apply_filters( 'bookawesome_widget_template_theme_dir', 'widgets/' );
		$plugin_path = BOOKAWESOME_PLUGIN_DIR . 'templates/widgets/';
		...
		return apply_filters( 'bookawesome_widget_locate_template', $path, $filename );
	}
}
