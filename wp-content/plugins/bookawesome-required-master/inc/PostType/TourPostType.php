...
class TourPostType extends AbstractPostType {

	protected $posType = 'bookawesome_tour';
	...
	public function labels(){
		return array(
			'name'                  => _x( 'Tous', 'Tour General Name', 'bookawesome' ),
			'singular_name'         => _x( 'Tour', 'Tour Singular Name', 'bookawesome' ),
			'menu_name'             => __( 'Tous', 'bookawesome' ),
			'name_admin_bar'        => __( 'Tous', 'bookawesome' ),
	...
	public function argsRegister(){
		return array(
			'label'                 => __( 'Tour', 'bookawesome' ),
			'description'           => __( 'Tour Description', 'bookawesome' ),
			'labels'                => $this->labels(),
			...
			'menu_icon'             => BOOKAWESOME_BASE_URL_PLUGIN . '/assets/backend/imgs/icon-beach.png',
		);
	}
