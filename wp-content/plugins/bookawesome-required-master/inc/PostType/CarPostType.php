...
class CarPostType extends AbstractPostType {

	protected $posType = 'bookawesome_car';
	...
	public function labels(){
		return array(
			'name'                  => _x( 'Cars', 'Car General Name', 'bookawesome' ),
			'singular_name'         => _x( 'Car', 'Car Singular Name', 'bookawesome' ),
			'menu_name'             => __( 'Cars', 'bookawesome' ),
			'name_admin_bar'        => __( 'Cars', 'bookawesome' ),
	...
	public function argsRegister(){
		return array(
			'label'                 => __( 'Car', 'bookawesome' ),
			'description'           => __( 'Car Description', 'bookawesome' ),
			'labels'                => $this->labels(),
			...
			'menu_icon'             => BOOKAWESOME_BASE_URL_PLUGIN . '/assets/backend/imgs/icon-car.png',
		);
	}
