...
class FlightPostType extends AbstractPostType {

	protected $posType = 'bookawesome_flight';
	...
	public function labels(){
		return array(
			'name'                  => _x( 'Flights', 'Flight General Name', 'bookawesome' ),
			'singular_name'         => _x( 'Flight', 'Flight Singular Name', 'bookawesome' ),
			'menu_name'             => __( 'Flights', 'bookawesome' ),
			'name_admin_bar'        => __( 'Flights', 'bookawesome' ),
	...
	public function argsRegister(){
		return array(
			'label'                 => __( 'Flight', 'bookawesome' ),
			'description'           => __( 'Flight Description', 'bookawesome' ),
			'labels'                => $this->labels(),
			...
			'menu_icon'             => BOOKAWESOME_BASE_URL_PLUGIN . '/assets/backend/imgs/icon-flight.png',
		);
	}
