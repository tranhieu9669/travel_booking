...
class PackagePostType extends AbstractPostType {

	protected $posType = 'bookawesome_package';
	...
	public function labels(){
		return array(
			'name'                  => _x( 'Packages', 'Package General Name', 'bookawesome' ),
			'singular_name'         => _x( 'Package', 'Package Singular Name', 'bookawesome' ),
			'menu_name'             => __( 'Packags', 'bookawesome' ),
			'name_admin_bar'        => __( 'Packages', 'bookawesome' ),
	...
	public function argsRegister(){
		return array(
			'label'                 => __( 'Package', 'bookawesome' ),
			'description'           => __( 'Package Description', 'bookawesome' ),
			'labels'                => $this->labels(),
			...
			'menu_icon'             => BOOKAWESOME_BASE_URL_PLUGIN . '/assets/backend/imgs/icon-package.png',
		);
	}
